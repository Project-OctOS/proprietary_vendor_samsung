...
//[ SEC_PRODUCT_FEATURE_AUDIO_DHA_SOL_MAL2
int mixer_ctl_set_param(struct mixer_ctl *ctl, struct snd_ctl_elem_value *ev);
//]
//[ SEC_PRODUCT_FEATURE_AUDIO_EAR_CARE
int mixer_ctl_get_param(struct mixer_ctl *ctl, struct snd_ctl_elem_value *ev);
//]
